              ...
              <View style={styles.gemInfo}>
                <View style={styles.gemMetaRow}>
                  ...
                  <Text style={[styles.refText, { color: colors.textMuted }]}>
                    Ref: {ap.gemId.slice(0, 4)}
                  </Text>
                </View>
                <Text style={[styles.gemTitle, { color: colors.onSurface }]}>
                  Blue Sapphire
                </Text>
                <Text
            ...
            <FormSection title="Outcome" padded={false}>
              <View style={styles.outcomeGrid}>
                <Pressable
                  style={[
                    styles.outcomeCard,
                    {
                      ...
                      borderColor:
                        outcome === "sold" ? colors.primary : "transparent",
                    },
                    outcome === "sold" && {
                ...
                >
                  ...
                  <Text
                    style={[styles.outcomeText, { color: colors.onSurface }]}
                  >
                    Sold
                  </Text>
                  {outcome === "sold" && (
                ...
                <Pressable
                  style={[
                    styles.outcomeCard,
                    {
                      backgroundColor: colors.surfaceGlass,
                      borderColor:
                        outcome === "returned" ? colors.primary : "transparent",
                    },
                    outcome === "returned" && {
                      backgroundColor: colors.primaryFixed + "33",
                    },
