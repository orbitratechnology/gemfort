  ...
  return (
    <ThemedView style={styles.container}>
      <View style={styles.headerRow}>
        ...
        {unread > 0 ? (
          <Button title="Mark all read" icon="done-all" variant="ghost" onPress={handleMarkAllRead} />
        ) : null}
      </View>
      <FlatList
        data={notifications}
        ...
        renderItem={({ item: n }) => (
          <Pressable onPress={() => handleTap(n.id, n.referenceType, n.referenceId)}>
            <Card
              style={[
                styles.card,
                !n.isRead && { borderLeftWidth: 3, borderLeftColor: ts.colors.accent },
              ]}>
              <View style={styles.cardRow}>
                <View style={[styles.iconWrap, { backgroundColor: ts.colors.primaryMuted }]}>
                  <Icon name={iconForType(n.type)} size={20} color={ts.colors.primary} />
                </View>
