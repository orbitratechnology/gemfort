...
export const GEM_TYPES = [
  {
    ...
    image: require('@/assets/images/gems/sapphire.webp') as ImageSourcePropType,
  },
  {
    value: 'blue_sapphire',
    label: 'Blue Sapphire',
    icon: 'diamond' as IconName,
    image: require('@/assets/images/gems/blue-sapphire.webp') as ImageSourcePropType,
  },
  {
    value: 'ruby',
    label: 'Ruby',
    icon: 'favorite' as IconName,
    image: require('@/assets/images/gems/ruby.webp') as ImageSourcePropType,
  },
  {
    value: 'padparadscha',
    label: 'Padparadscha',
    icon: 'wb-sunny' as IconName,
    image: require('@/assets/images/gems/padparadscha.webp') as ImageSourcePropType,
  },
  {
    value: 'emerald',
    label: 'Emerald',
    icon: 'eco' as IconName,
    image: require('@/assets/images/gems/emerald.webp') as ImageSourcePropType,
  },
  {
    value: 'star_sapphire',
    label: 'Star Sapphire',
    icon: 'star' as IconName,
    image: require('@/assets/images/gems/star-sapphire.webp') as ImageSourcePropType,
  },
  {
    value: 'cat_eye',
    label: "Cat's Eye",
    icon: 'visibility' as IconName,
    image: require('@/assets/images/gems/cats-eye.webp') as ImageSourcePropType,
  },
  {
    value: 'spinel',
    label: 'Spinel',
    icon: 'hexagon' as IconName,
    image: require('@/assets/images/gems/spinel.webp') as ImageSourcePropType,
  },
  {
    value: 'garnet',
    label: 'Garnet',
    icon: 'brightness-1' as IconName,
    image: require('@/assets/images/gems/garnet.webp') as ImageSourcePropType,
  },
  {
    value: 'tourmaline',
    label: 'Tourmaline',
    icon: 'water-drop' as IconName,
    image: require('@/assets/images/gems/tourmaline.webp') as ImageSourcePropType,
  },
  {
    value: 'alexandrite',
    label: 'Alexandrite',
    icon: 'auto-awesome' as IconName,
    image: require('@/assets/images/gems/alexandrite.webp') as ImageSourcePropType,
  },
  {
    value: 'amethyst',
    label: 'Amethyst',
    icon: 'spa' as IconName,
    image: require('@/assets/images/gems/amethyst.webp') as ImageSourcePropType,
  },
  {
    value: 'ametrine',
    label: 'Ametrine',
    icon: 'auto-awesome' as IconName,
    image: require('@/assets/images/gems/ametrine.webp') as ImageSourcePropType,
  },
  {
    value: 'aquamarine',
    label: 'Aquamarine',
    icon: 'water-drop' as IconName,
    image: require('@/assets/images/gems/aquamarine.webp') as ImageSourcePropType,
  },
  {
    value: 'citrine',
    label: 'Citrine',
    icon: 'wb-sunny' as IconName,
    image: require('@/assets/images/gems/citrine.webp') as ImageSourcePropType,
  },
  {
    value: 'diamond',
    label: 'Diamond',
    icon: 'diamond' as IconName,
    image: require('@/assets/images/gems/diamond.webp') as ImageSourcePropType,
  },
  {
    value: 'fancy_color_diamond',
    label: 'Fancy Color Diamond',
    icon: 'auto-awesome' as IconName,
    image: require('@/assets/images/gems/fancy-color-diamond.webp') as ImageSourcePropType,
  },
  {
    value: 'iolite',
    label: 'Iolite',
    icon: 'brightness-2' as IconName,
    image: require('@/assets/images/gems/iolite.webp') as ImageSourcePropType,
  },
  {
    value: 'jade',
    label: 'Jade',
    icon: 'eco' as IconName,
    image: require('@/assets/images/gems/jade.webp') as ImageSourcePropType,
  },
  {
    value: 'kunzite',
    label: 'Kunzite',
    icon: 'favorite' as IconName,
    image: require('@/assets/images/gems/kunzite.webp') as ImageSourcePropType,
  },
  {
    value: 'lapis_lazuli',
    label: 'Lapis Lazuli',
    icon: 'palette' as IconName,
    image: require('@/assets/images/gems/lapis-lazuli.webp') as ImageSourcePropType,
  },
  {
    value: 'moonstone',
    label: 'Moonstone',
    icon: 'brightness-3' as IconName,
    image: require('@/assets/images/gems/moonstone.webp') as ImageSourcePropType,
  },
  {
    value: 'morganite',
    label: 'Morganite',
    icon: 'favorite' as IconName,
    image: require('@/assets/images/gems/morganite.webp') as ImageSourcePropType,
  },
  {
    value: 'opal',
    label: 'Opal',
    icon: 'flare' as IconName,
    image: require('@/assets/images/gems/opal.webp') as ImageSourcePropType,
  },
  {
    value: 'pearl',
    label: 'Pearl',
    icon: 'circle' as IconName,
    image: require('@/assets/images/gems/pearl.webp') as ImageSourcePropType,
  },
  {
    value: 'peridot',
    label: 'Peridot',
    icon: 'eco' as IconName,
    image: require('@/assets/images/gems/peridot.webp') as ImageSourcePropType,
  },
  {
    value: 'rose_quartz',
    label: 'Rose Quartz',
    icon: 'favorite' as IconName,
    image: require('@/assets/images/gems/rose-quartz.webp') as ImageSourcePropType,
  },
  {
    value: 'sunstone',
    label: 'Sunstone',
    icon: 'wb-sunny' as IconName,
    image: require('@/assets/images/gems/sunstone.webp') as ImageSourcePropType,
  },
  {
    value: 'tanzanite',
    label: 'Tanzanite',
    icon: 'diamond' as IconName,
    image: require('@/assets/images/gems/tanzanite.webp') as ImageSourcePropType,
  },
  {
    value: 'topaz',
    label: 'Topaz',
    icon: 'hexagon' as IconName,
    image: require('@/assets/images/gems/topaz.webp') as ImageSourcePropType,
  },
  {
    value: 'turquoise',
    label: 'Turquoise',
    icon: 'water-drop' as IconName,
    image: require('@/assets/images/gems/turquoise.webp') as ImageSourcePropType,
  },
  {
    value: 'zircon',
    label: 'Zircon',
    icon: 'brightness-1' as IconName,
    image: require('@/assets/images/gems/zircon.webp') as ImageSourcePropType,
  },
  {
    value: 'amber',
    label: 'Amber',
    icon: 'local-fire-department' as IconName,
    image: require('@/assets/images/gems/amber.webp') as ImageSourcePropType,
  },
  {
    value: 'other',
    label: 'Other',
    icon: 'more-horiz' as IconName,
    image: require('@/assets/images/gems/other.webp') as ImageSourcePropType,
  },
] as const;
